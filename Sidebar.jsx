    ...
    >
      ...
      <nav className="flex-1 flex flex-col gap-0.5 px-2 pt-3 overflow-y-auto">
        ...
        {!collapsed && (
          <div className="px-1 pb-2">
            <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-600 mb-2 px-2">
              Live status
            </p>
      ...
      {!collapsed && (
        <div className="px-2 pb-3">
          <NavLink
            to="/"
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-slate-400 dark:text-slate-600 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
      ...
      <button
        ...
        className="mx-2 mb-4 flex items-center justify-center h-8 rounded-lg text-slate-400 dark:text-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-300 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
      >
        <svg
          width="14"
          height="14"
